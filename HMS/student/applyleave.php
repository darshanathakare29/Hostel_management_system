...
$sql = "SELECT * FROM leaverequests WHERE reg_no='$regno' AND status='Pending'";
...
$errmsg="*You entered wrong information";
  ...
  $errmsg="*You already had a leave";
   ...
   require_once('../dbConnect.php');
 $sql="INSERT INTO `leaverequests` (`name`,`reg_no`,`block`,`roomno`,`fromdate`,`todate`,`reason`,`status`)VALUES ('$name','$regno','$block','$roomno','$fromdate','$todate','$reason','Pending')";
      ...
      <form action="applyleave.php" method="post">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="number" placeholder="Enter your room " value="<?php echo $roomno; ?>"  required>
          </div>
          <div class="input-box">
