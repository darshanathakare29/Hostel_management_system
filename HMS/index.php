...
<div class="Nav" id="Nav1">
  <div class="NavbarContainer">
    ...
    <ul class="NavMenu ">
      ...
      <li class="NavItem"><a id="linkcolor4" class="NavLinks" href="mess.php">Mess&Meal</a></li>
...
<div class="HeroContainer">
  ...
  <source src="videos\sinhgad video.mp4" type="video/mp4">
</video>
  </div>
<div class="HeroContent">
  <h1 class="HeroH1">Hostel Management System</h1>
  <p class="HeroP">SINHGAD INSTITUTE</p>
...
<h1 class="Heading">100% HYGIENE ASSURED!!</h1>
<p class="Subtitle">Taste dishes across all over Maharashtra.</p>
<div class="BtnWrap">
<button type="button" name="button" class="NavBtnLink">Get Started</button>
</div>
</div>
...
<div class="FooterWrap">
  ...
  <div class="SocialMedia">
    <div class="SocialMediaWrap">
      ...
      <p class="WebsiteRights">Sinhagad Institute</p>
      <div class="SocialIcons">
        <a href="https://www.facebook.com/SinhgadInstitutes.STES?mibextid=ZbWKwL" class="SocialIconLink"><i class="fa fa-facebook-square" aria-hidden="true"></i></a>
        <a href="https://www.instagram.com/sinhgadinstitutes?igsh=YXBqcTMzbDlydmxx" class="SocialIconLink"><i class="fa fa-instagram" aria-hidden="true"></i></a>
        <a href="https://youtube.com/@sinhgadinstitutes218?si=aClni7E30bL1zBph" class="SocialIconLink"><i class="fa-brands fa-youtube"></i></a>
      </div>
    </div>
